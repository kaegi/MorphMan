...
class Ui_ReadabilityDialog(object):
    def setupUi(self, ReadabilityDialog):
        ...
        self.matureMorphsLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignBottom|QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft)
        self.matureMorphsLabel.setObjectName("matureMorphsLabel")
        self.verticalLayout_3.addWidget(self.matureMorphsLabel)
        self.horizontalLayout_MatureMorphs = QtWidgets.QHBoxLayout()
        self.horizontalLayout_MatureMorphs.setObjectName("horizontalLayout_MatureMorphs")
        self.matureMorphsButton = QtWidgets.QPushButton(self.generalSettingsGroupBox)
        self.matureMorphsButton.setObjectName("matureMorphsButton")
        self.horizontalLayout_MatureMorphs.addWidget(self.matureMorphsButton)
        self.matureMorphsEdit = QtWidgets.QLineEdit(self.generalSettingsGroupBox)
        self.matureMorphsEdit.setObjectName("matureMorphsEdit")
        self.horizontalLayout_MatureMorphs.addWidget(self.matureMorphsEdit)
        self.verticalLayout_3.addLayout(self.horizontalLayout_MatureMorphs)
...
"The expected format is that of a instance_freq_report.txt file."))
        ...
        self.matureMorphsLabel.setText(_translate("ReadabilityDialog", "Mature Morphs DB"))
        self.matureMorphsButton.setText(_translate("ReadabilityDialog", "..."))
        self.matureMorphsEdit.setToolTip(_translate("ReadabilityDialog", "Path to use as your \'Mature\' morphs database."))
