...
class AdaptiveSubWin(QDialog):
    def __init__(self, morphemizerRegistry, parent=None):
        ...
        self.morphemizerComboBox = MorphemizerComboBox(morphemizerRegistry)
...
class MorphMan(QDialog):
    def __init__(self, morphemizerRegistry, parent=None):
        ...
        self.adaptiveSubs = mkBtn(
          'Adaptive Subs',
          lambda: self.adaptiveSubsMethod(morphemizerRegistry),
          vbox)
    ...
    def adaptiveSubsMethod(self, morphemizerRegistry):
        self.hide()
        asw = AdaptiveSubWin(morphemizerRegistry, self.mw)
        asw.show()
...
def main():
    mw.mm = MorphMan(mw.morphemizerRegistry, mw)
    mw.mm.show()
