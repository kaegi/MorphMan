...
class PreferencesDialog( QDialog ):
    ...
    def createGeneralTab(self):
        ...
        optionList  = [
                ...
                ("Ignore everything contained within brackets", 'Option_IgnoreBracketContents', 'Use this option to ignore content such as readings/pitch generated by the MIA Japanese Support addon.')
            ]
        self.boolOptionList = []
