...
from morphemes import AnkiDeck, MorphDb, getMorphemes2, getMorphemizerForNote, ms2str
...
def per( st, n ):
    ...
    for f in cfg( n.mid, None, 'morph_fields' ):
        ms = getMorphemes2(getMorphemizerForNote(n), n[ f ], None, cfg1('morph_blacklist') )
