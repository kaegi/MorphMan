...
- **Korean**: You must additionally download the Korean dictionary [here](https://github.com/Pusnow/mecab-ko-dic-msvc), rename it "mecab-ko-dic" and put it in morph/deps/mecab. 
